...
This section adds a few Exploratory Data Analysis techniques where we will measure and look at distances between samples based on normalized data. **heatmap**
...
I did it as first step before start with dashboerd maybe we need also to store the deg_6_filtered ! ...

```{r}
Rds6File <- data.frame(deg_6$deg)
#View(deg_6$deg)
# Save a DESeq2 results object to a file
saveRDS(Rds6File, "data/Rds6File.rds")
#saveRDS(deg_36, "data/deg_36.rds")
