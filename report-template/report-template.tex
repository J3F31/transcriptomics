...
\abstract{%
Pharmaceutical pollutants, including the antidepressant fluoxetine
(FLX), are increasingly detected in aquatic environments, raising
concerns about their effects on non-target organisms. The original study
demonstrated that environmentally-relevant FLX concentrations promote
wound closure in human keratinocytes through enhanced cell proliferation
and serotonin signalling. Building on these findings, the present study
extends the transcriptomic analysis by examining gene expression in
scratched HaCaT keratinocytes exposed to 540 ng/L FLX at 6 and 36 hours.
We identified 147 DEGs at 6 hours and 242 DEGs at 36 hours, with
upregulated genes associated with cell proliferation and cellular stress
defence. The difference in DEG numbers compared to the original study
reflects sample quality filtering applied during data processing. These
results support the conclusion that environmental FLX exposure modulates
gene expression in ways that may meaningfully impact skin wound healing.
}
...
widely prescribed selective serotonin reuptake inhibitors (SSRIs). Due
to incomplete metabolisation in the human body and inadequate removal by
...
Serotonin plays a well-established role in peripheral tissues, including
the skin, where it is involved in regulating cell proliferation and
wound healing. Wound healing proceeds through three overlapping phases:
inflammation, proliferation, and tissue remodeling. During the
proliferation phase, keratinocytes migrate toward the wound edge and
actively divide to restore the skin barrier. Given that FLX modulates
serotonin signalling, it is biologically plausible that environmental
FLX exposure could influence skin repair mechanisms.

The original study by \citep{rodriguez:2024} was the first to
investigate this link experimentally, identifying 350 DEGs in
FLX-exposed keratinocytes, with upregulated genes linked to cell
proliferation and downregulated genes associated with mitochondrial
function \citep{rodriguez:2024}.

The present study focuses exclusively on the transcriptomic component of
the original research, analysing gene expression in scratched HaCaT
keratinocytes exposed to 540 ng/L FLX at 6 and 36 hours. Our central
research question is: does FLX exposure significantly alter gene
expression in human keratinocytes in ways that support enhanced wound
healing, and how does this response evolve between 6 and 36 hours?
...
adult human skin, widely used as a model system in dermatological
research, and were obtained from AddexBio. Cells were maintained in 5\%
CO2 at 37 °C and subcultured every 3 days or at approximately 80\%
confluency. A scratch assay was performed on HaCaT monolayers to
simulate wound healing, followed by FLX treatment at 540 ng/L.
Conditions were defined as a combination of treatment (FLX vs.~control)
and time post-scratch (6 h and 36 h).
...
time point (6 h and 36 h) using the DESeq2 R package, with genes
considered differentially expressed at an unadjusted p-value threshold
of \texttt{p\ \textless{}\ 0.05}. Unadjusted p-values were used in place
of adjusted p-values (padj), as this approach yielded results most
comparable to those reported in the original study.

Three complementary enrichment analyses were performed using the
clusterProfiler and ReactomePA R packages, with gene annotations
provided by \texttt{org.Hs.eg.db} and \texttt{Entrez} gene IDs
(ENTREZID) as the primary identifier, all at a significance threshold of
\texttt{p\ \textless{}\ 0.05} without p-value adjustment. Gene Ontology
(GO) enrichment was performed across all three ontology domains ---
Biological Process (BP), Cellular Component (CC), and Molecular Function
(MF) --- as each captures a distinct aspect of gene function. KEGG
pathway enrichment was applied to identify significantly represented
biological pathways among the DEGs, with gene set sizes restricted
between 10 and 500 genes. Reactome pathway enrichment was additionally
used to identify precise molecular reactions and sub-pathways driven by
the DEGs.
...
36 h post-scratch). Prior to sample cleaning, our DESeq2 analysis
yielded exactly the same number of DEGs as reported in the original
article: 165 DEGs at 6 h and 350 DEGs at 36 h. Following the removal of
three irregular samples identified during quality control, the number of
DEGs decreased to 147 at 6 h (86 upregulated, 61 downregulated) and 242
at 36 h (110 upregulated, 132 downregulated). The genes identified after
cleaning appear to be a subset of those found before cleaning,
suggesting that sample removal reduced statistical power rather than
introducing different signals. Notably, replicating the original DEG
counts was only achievable using unadjusted p-values, despite the
article stating padj was used, which remains an open question and a
limitation of the current analysis. Finally, a Venn diagram comparison
revealed three genes shared across both time points --- NRARP, TMEM238,
and IKBKGP1 --- suggesting they may play an ongoing role in the cellular
response to FLX during wound healing.
