...
The original study by \citet{R} Hossain et al.~(2024) was the first to
...
associated with mitochondrial function and metabolism (Hossain et al.,
2024). These findings provided a molecular basis for the observed
enhancement in wound closure, but left room for deeper temporal
investigation of how gene expression changes evolve over time during FLX
exposure.
...
the original study (Hossain et al., 2024). The 6-hour time point
...
the original article \citet{R}(Hossain et al., 2024).
=======
